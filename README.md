...
- A [DC/OS 1.12](https://dcos.io/releases/) or higher cluster using the Universal Installer., with 1 Master node, 1 Public Agent node, and at minimum 5 Private Agent nodes.
  ...
  - main.tf, 00-BuildDCOS.sh, 99-DestroyDCOS.sh files may be used for DC/OS cluster setup and tear down. 
    - NOTE: Review and update each file to ensure the correct MAWS account, and license file is referenced.
